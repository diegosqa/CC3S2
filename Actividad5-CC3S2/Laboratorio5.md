...
## Parte 6: Automatización de rebase con hooks de Git

### Instrucciones:

#### Paso 1: Configurar un hook `pre-push`:

![Comando](Imagenes/Foto15.PNG)

#### Paso 2: Editar el archivo hook:

```bash
nano .git/hooks/pre-push
```

#### Paso 3: Agregar el siguiente script en el archivo:
...
#### Paso 4: Hacer el archivo ejecutable:
...
- **¿Qué ventajas y desventajas observas al automatizar el rebase en un entorno CI/CD?**
   - Ventajas: Se asegura que siempre se rebase antes de hacer push, lo que mantiene el historial limpio y facilita la integración de cambios.
   - Desventajas: Puede causar conflictos automáticos o fallos en el rebase si no se resuelven adecuadamente los conflictos previos.

---

## Parte 7: Simulación de flujo Scrum en Git: Conflictos y Resolución

### Instrucciones:

#### Paso 1: Crear ramas con cambios conflictivos:

![Comando](command_image)

#### Paso 2: Intentar hacer merge en `main` y resolver conflictos:

![Comando](command_image)

**Pregunta:**

- **¿Cómo manejarías los conflictos de fusión al final de un sprint?**
   - Al final del sprint, los conflictos de fusión deben resolverse mediante revisión manual. Es esencial que el equipo revise los cambios conflictivos, elimine las diferencias no deseadas, y finalmente cree un commit de resolución que represente la fusión final.
